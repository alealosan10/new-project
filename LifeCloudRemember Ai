# LifeCloudRemember AI: Memory Companion

Final project for the Building AI course

## Summary

LifeCloudRemember AI is a digital memory assistant that helps users store, organize, and narrate their life stories. By integrating various data sources, it enables individuals, especially those with memory challenges, to relive important moments and maintain emotional connections.

## Background

LifeCloudRemember AI addresses the challenge of memory decline and the difficulty of managing a vast amount of digital content. This problem is common, particularly among the elderly and individuals with cognitive impairments. My personal motivation stems from a desire to leverage technology to enhance emotional well-being and preserve personal histories.

## How is it used?

LifeCloudRemember AI is utilized by individuals wanting to manage their digital lives, caregivers assisting loved ones with memory challenges, and therapists using it for therapeutic purposes. It functions in everyday life, continuously collecting data from devices, social media, and other sources.
...
LifeCloudRemember AI collects data from various sources, including:
...
LifeCloudRemember AI does not solve all memory-related issues. Limitations include:
